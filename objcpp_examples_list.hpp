...
public:
    ...
    // Pop the last element out from the list and return the pointer to it
...
private:
    ...
    pmem::obj::persistent_ptr<list_entry> remove_elm(pmem::obj::persistent_ptr<list_entry> elm)
    {
        assert(elm != nullptr);
        auto tmp = elm->next;
