...
void pool_example()
{
    ...
    pop.memcpy_persist(root_obj->some_other_array, root_obj->some_array, sizeof(root_obj->some_array));
...
void pool_base_example()
{
    ...
    pop.memcpy_persist(pval->some_other_array, pval->some_array, sizeof(pval->some_array));
